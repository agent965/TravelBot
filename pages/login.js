  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-white px-4">
      <div className="bg-slate-800 p-8 rounded-xl max-w-md w-full">
        ...
        <h1 className="text-3xl font-bold mt-6 mb-2">Welcome to TrackRoth</h1>
        <p className="text-gray-400 mb-8">Sign in to start tracking flights</p>

        {/* Google Sign In */}
        <button
          onClick={() => signIn('google', { callbackUrl: '/dashboard' })}
          className="w-full bg-white text-gray-800 py-3 rounded-lg font-semibold flex items-center justify-center gap-3 hover:bg-gray-100 transition mb-4"
        >
